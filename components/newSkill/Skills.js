    ...
    return (
        ...
        <div className="w-full md:h-[100vh]  lg:px-44 flex">
            ...
            <div className="w-full   md:h-[100vh] lg:h-[100vh] flex flex-col gap-10 justify-center items-center  " id="skills">
               <Reveal><h1 style={{ fontFamily: 'Transcity' }} className=" my-10 pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-black to-gray-300/80 bg-clip-text text-center md:text-8xl text-6xl font-semibold leading-none text-transparent dark:from-[#fff] dark:to-slate-900/10" > My Skills</h1></Reveal> 
                ...
                <div className="  border-white border-0 md:flex  justify-around items-center py-10 px-3 rounded-3xl md:bg-[#ffffff07] " >
                    ...
                    <div className=" md:w-[40%] w-full">
                       ...
                       className="pt-0 pb-5 flex-col flex  space-y-0"
                        ...
                        <h2 className=" text-2xl font-bold text-[#F0BB78]"> <LettersPullUp text="AI & NLP Expertise:"/> </h2>
