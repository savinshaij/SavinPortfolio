    ...
    <>
      <div className="  pb-20" >
        ...
        <div className="flex flex-col gap-10 justify-center items-center text-center py-28  pt-10"
          id='exp'
        >
          <Reveal><h1 style={{ fontFamily: 'Transcity' }} className=" my-10 pointer-events-none whitespace-pre-wrap bg-gradient-to-b  bg-clip-text text-center md:text-8xl text-6xl font-semibold leading-none text-transparent from-[#fff] to-slate-900/10" > My Projects</h1></Reveal>
        </div>
